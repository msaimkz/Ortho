                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="body">
                                ...
                                <div class="form-group">
                                    <textarea rows="4" class="form-control no-resize" name="content" id="content" placeholder="Please Write  Content..."></textarea>
                                    <span class="text-danger"></span>
                                </div>
                            </div>
                        </div>
...
@section('js')
    ...
    <script>
        ...
        $('#ChapterForm').submit(function(event) {
            ...
            $.ajax({
                url: "{{ route('Admin.course.chapter.store',$course->id) }}",
                type: "post",

    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-4 col-md-6">
                <div class="card">
                    <div class="body">
                        <h3 class="number count-to m-b-0" data-from="0" data-to="{{ $patientCounts }}" data-speed="2500" data-fresh-interval="700">{{ $patientCounts }} <i class="zmdi zmdi-trending-up float-right"></i></h3>

                            ...
                            <div class="body">
                                <div class="form-group">
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="Enter Subscription Name" value="{{ $subscription->name }}" />
                            ...
                            <div class="body">
                                <div class="form-group">
                                    <input type="text" readonly name="slug" id="slug" class="form-control"
                                        placeholder="Enter Subscription Slug" value="{{ $subscription->slug }}" />
                                    <span class="text-danger"></span>
                        ...
                        <div class="card">
                            <div class="body">
                                ...
                                <select name="plan" id="plan" class="form-control">
                                    ...
                                    <option value="free" {{ $subscription->plan == 'free' ? 'selected' : '' }}>Free
                                    </option>
                                    <option value="professional"
                                        {{ $subscription->plan == 'professional' ? 'selected' : '' }}>Professional</option>
                                    <option value="community" {{ $subscription->plan == 'community' ? 'selected' : '' }}>
                                        Community</option>
                        ...
                        <div class="card">
                            <div class="body">
                                <input type="text" name="annual_price" id="annual_price" class="form-control"
                                    ...
                                    value="{{ $subscription->annual_price }}" />
                                <span class="text-danger"></span>
                            ...
                            <div class="body">
                                ...
                                <div class="form-group">
                                    <textarea rows="4" name="description" id="description" class="form-control no-resize"
                                        placeholder="Please Write  Subscription Description...">{{ $subscription->description }}</textarea>
                                    <span class="text-danger"></span>
                                </div>
                            </div>
                        </div>

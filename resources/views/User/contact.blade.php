        ...
        <div class="col-lg-6">
          <div class="cs_contact_thumbnail cs_pr_40">
            <div class="cs_teeth_shape">
              <img src="{{ asset('Assets/user/assets/img/icons/hero_shape_3.png') }}" alt="Image" class="cs_spinner_img">
            </div>
            ...
            <div class="cs_contact_bg_shape">
              ...
              <div class="cs_iconbox cs_style_4">
                <div class="cs_iconbox_icon cs_center"><img src="{{ asset('Assets/User/assets/img/icons/call_icon_1.png') }}" alt="Icon"></div>

                                    ...
                                    <tbody>
                                        @if (isset($doctorRequests) && !$doctorRequests->isEmpty())
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('User.dashboard.DoctorRequestProfile',$doctorRequest->id) }}"><span class="badge badge-info">View More</span></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        @else
                                            ...
                                            <tr>
                                                <td colspan="5" class="text-center">You Don't Send Request</td>
                                            </tr>
                                        @endif

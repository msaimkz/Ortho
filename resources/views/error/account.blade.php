                ...
                <div class="card-plain">
                    <form class="form" method="" action="#">
                        <div class="header">
                            ...
                            <span>Your Account is Blocked By Admin</span>
                        </div>
                        <div class="content">
                        ...
                        <div class="footer text-center">
                            <a href="{{ route('User.index') }}"
                                class="btn btn-primary btn-round btn-block  waves-effect waves-light">GO TO HOMEPAGE</a>
                        </div>
                    </form>
                </div>
            </div>
...
<!-- Mirrored from wrraptheme.com/templates/oreo/hospital/html/light/500.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 04:00:50 GMT -->

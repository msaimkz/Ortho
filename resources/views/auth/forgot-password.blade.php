                ...
                <form class="form" method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="content">
                        <div class="input-group">
                            <input  id="email"  type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" class="form-control" placeholder="Enter Email">
                    ...
                    <div class="footer text-center">
                        <button type="submit" class="btn btn-primary btn-round btn-block  waves-effect waves-light">SUBMIT</button>
                    </div>
                </form>
            </div>
        </div>
